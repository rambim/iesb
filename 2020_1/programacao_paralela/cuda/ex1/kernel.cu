...
{
    printf("\nX = Total Blocks: %d Total Threads:  %d Block: %d Thread: %d", gridDim.x, blockDim.x, blockIdx.x, threadIdx.x);
    printf("\nY = Total Blocks: %d Total Threads:  %d Block: %d Thread: %d", gridDim.y, blockDim.y, blockIdx.y, threadIdx.y);
