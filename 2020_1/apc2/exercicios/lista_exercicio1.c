...
3) (0,2) Faça o programa que apresenta a seguinte saída, perguntando ao usuário o número máximo (no exemplo, 9). 
...
5) (0,2) Crie um programa capaz de criar a transposta de uma matriz.
